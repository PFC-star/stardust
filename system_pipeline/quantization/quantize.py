...
def link_external_data(model_path: str, model_name: str):
    ...
    # while "LinguaLinked-Inference" not in os.path.basename(project_dir) and project_dir != "/":
    #     project_dir = os.path.dirname(project_dir)

    # if "LinguaLinked-Inference" not in os.path.basename(project_dir):
    #     raise RuntimeError("Could not find 'LinguaLinked-Inference' in the path hierarchy.")
