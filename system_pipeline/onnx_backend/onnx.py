...
# def model_output_size_(tokenizer,
#                       onnx_module_path,
#                       split_size,
...
#     # sdm_path = f"{onnx_module_path}/sender_seq_dep_map.json"
#     # rdm_path = f"{onnx_module_path}/sender_res_dep_map.json"
#     # with open(sdm_path, "r") as file:
#     #     sequential_dependency_map = json.load(file)
#     #     # json_str = json.dumps(sequential_dependency_map)
#     #     # print(json_str)
#     #     # sequential_dependency_map = json_str.replace('"','')
#     #     # print(json_str)
#     #     # sequential_dependency_map = json.loads(json_str)
#     #     print(sequential_dependency_map)
#     # with open(rdm_path, "r") as file:
#     #     residual_dependency_map = json.load(file)
#     #     # json_str = json.dumps(residual_dependency_map)
#     #     # residual_dependency_map = json_str.replace('"','')

#     # print(sequential_dependency_map, residual_dependency_map)

#     print("loading onnx_models...")
...
#         test_input.append(torch.cat((input_id,input_append),dim=1))
