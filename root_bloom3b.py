...
if __name__ == "__main__":
    ...
    data = [
        [str(headerIP), "/workspace/ams-LinguaLinked-Inference/onnx_model__/to_send/bloom3b_quantized_int8_res/device0/module0/module.zip"],
        [str(workerIP), '/workspace/ams-LinguaLinked-Inference/onnx_model__/to_send/bloom3b_quantized_int8_res/device1/module1/module.zip']
    ]
